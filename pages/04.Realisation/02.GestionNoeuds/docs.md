...
La fonction on() va pouvoir intercepter un évenement tel que la [connexion ou déconnexion d'un noeud esclave](https://github.com/TPCISIIE/WebLab/blob/master/Master/public/js/controller/controller.js) et pourra alors prévenir les entités écoutantes (appelées listeners) via la fonction emit() qui a pour rôle de les notifier. 
